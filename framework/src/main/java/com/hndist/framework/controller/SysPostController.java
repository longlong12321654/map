...
public class SysPostController extends BaseController
{
     ...
     * 获取岗位列表
     */
    //@PreAuthorize("@ss.hasPermi('framework:post:list')")
    @GetMapping("/list")
    ...
    //@PreAuthorize("@ss.hasPermi('framework:post:export')")
    @PostMapping("/export")
     ...
     * 根据岗位编号获取详细信息
     */
    //@PreAuthorize("@ss.hasPermi('framework:post:query')")
     ...
     * 新增岗位
     */
    //@PreAuthorize("@ss.hasPermi('framework:post:add')")
     ...
     * 修改岗位
     */
    //@PreAuthorize("@ss.hasPermi('framework:post:edit')")
     ...
     * 删除岗位
     */
    //@PreAuthorize("@ss.hasPermi('framework:post:remove')")
