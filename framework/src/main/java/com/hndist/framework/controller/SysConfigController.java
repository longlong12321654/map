...
public class SysConfigController extends BaseController
{
     ...
     * 获取参数配置列表
     */
    //@PreAuthorize("@ss.hasPermi('framework:config:list')")
    @GetMapping("/list")
    ...
    //@PreAuthorize("@ss.hasPermi('framework:config:export')")
    @PostMapping("/export")
     ...
     * 根据参数编号获取详细信息
     */
    //@PreAuthorize("@ss.hasPermi('framework:config:query')")
     ...
     * 新增参数配置
     */
    //@PreAuthorize("@ss.hasPermi('framework:config:add')")
     ...
     * 修改参数配置
     */
    //@PreAuthorize("@ss.hasPermi('framework:config:edit')")
     ...
     * 删除参数配置
     */
    //@PreAuthorize("@ss.hasPermi('framework:config:remove')")
