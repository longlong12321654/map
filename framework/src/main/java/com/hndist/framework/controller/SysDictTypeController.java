...
import com.hndist.framework.domain.SysDictType;
...
import com.hndist.framework.service.ISysDictTypeService;
...
public class SysDictTypeController extends BaseController
{
    ...
    //@PreAuthorize("@ss.hasPermi('framework:dict:list')")
    @GetMapping("/list")
    ...
    //@PreAuthorize("@ss.hasPermi('framework:dict:export')")
    @PostMapping("/export")
     ...
     * 查询字典类型详细
     */
    //@PreAuthorize("@ss.hasPermi('framework:dict:query')")
     ...
     * 新增字典类型
     */
    //@PreAuthorize("@ss.hasPermi('framework:dict:add')")
     ...
     * 修改字典类型
     */
    //@PreAuthorize("@ss.hasPermi('framework:dict:edit')")
     ...
     * 删除字典类型
     */
    //@PreAuthorize("@ss.hasPermi('framework:dict:remove')")
