...
import com.hndist.framework.entity.Feature;
import com.hndist.framework.entity.Features;
import com.hndist.framework.entity.Message;
...
public class ArcGisUtil {
    ...
    //临时feature
    private static HashMap<String,Feature> featureHashMap = new HashMap<String,Feature>();
     ...
     * @Param [url]
     * @return com.hndist.gisserver.entity.Feature
     */
    public static Feature getFeature(String layerUrl){
        ...
        if(feature==null) {
            ...
            System.out.println(layerUrl+":::"+feature);
            System.out.println(layerUrl+"::"+tmp);
            //添加到缓存
     ...
     * @return org.jeecg.common.util.gisserver.bean.Message
     */
