 ...
 */
public class OmpMenuBase extends BaseEntity
{
    ...
    /** 子菜单 */
    private List<OmpMenuBase> children = new ArrayList<OmpMenuBase>();
    ...
    public List<OmpMenuBase> getChildren()
    {
        return children;
    }

    public void setChildren(List<OmpMenuBase> children)
    {
